<img width="705" height="771" alt="Edit_variables_3" src="https://github.com/user-attachments/assets/5a6d8998-a164-4e5a-a653-bf2aaed3f619" /><img width="979" height="292" alt="image" src="https://github.com/user-attachments/assets/5365c6b7-3d3e-48c8-b26e-3c06c2c81223" /># 🌐 Challenge 8 - Group 208
...
Truy cập trang cài đặt Terraform thông qua đường link sau: https://developer.hashicorp.com/terraform/install
...
- Thực hiện giải nén file .zip, bên trong sẽ bao gồm 1 file terraform.exe và 1 file license.txt
...
- Thực hiện copy đường dẫn tới file như hình sau:
...
- Gõ Edit the system enviroment variables trên thanh tìm kiếm:
...
- Click vào dòng chứa Path trong "System variables" và chọn Edit
...
- Chọn New và paste đường dẫn tới Folder terraform bạn vừa tải về sau đó chọn Ok
...
- Gõ cmd trên thanh tìm kiếm và sau đó thực hiện câu lệnh
...
```
- Nếu như màn hình trả ra kết quả như bên dưới thì bạn đã cài đặt thành công.
